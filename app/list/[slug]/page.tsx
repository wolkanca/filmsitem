...
function resolveCollection(
  ...
  if (manualListName) {
    return {
      ...
      description:
        `"${manualListName}" koleksiyonunda bulunan filmler, diziler, kişisel yorumlarım ve puanlarım.`,
