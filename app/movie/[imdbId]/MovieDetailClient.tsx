          ...
          <div className="glass bg-gradient-to-br from-zinc-900/60 to-red-950/10 p-6 sm:p-8 rounded-3xl border border-brand-primary/20 space-y-6 mb-8 shadow-[0_10px_35px_rgba(239,68,68,0.1)]">
            ...
            <div>
              ...
              <a
                ...
                className="ml-auto mt-4 flex items-center justify-center gap-2 px-4 py-1.5 rounded-lg text-lg font-bold bg-[#f5c518]/10 hover:bg-[#f5c518]/20 text-[#f5c518] border border-[#f5c518]/30 hover:border-[#f5c518]/60 transition-all duration-200 shadow-[0_0_12px_rgba(245,197,24,0.08)] hover:shadow-[0_0_16px_rgba(245,197,24,0.2)]"
              >
