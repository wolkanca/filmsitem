    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
      ...
      <div className="glass-card max-w-lg p-8 sm:p-12 rounded-3xl border border-card-border/50 relative">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
          <Link
            href="/"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white text-zinc-950 hover:bg-zinc-200 transition-colors px-6 py-3 rounded-xl font-bold text-xs"
          >
          ...
          <Link
            href="/movies"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-zinc-900 hover:bg-zinc-800 text-white border border-white/10 transition-colors px-6 py-3 rounded-xl font-bold text-xs"
          >
          ...
          <Link
            href="/random"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-brand-secondary/20 hover:bg-brand-secondary/30 text-brand-rose border border-brand-secondary/30 transition-colors px-6 py-3 rounded-xl font-bold text-xs"
          >
